...
const TypeBox = ({ textInputRef, handleInputFocus }) => {
  // local persist timer
          ...
          <Grid container justifyContent="center" alignItems="center">
            ...
            </Box>
            {
              <Box display="flex" flexDirection="row">
                ...
                >
                  <Tooltip title={   language === ENGLISH_MODE     ? DEFAULT_DIFFICULTY_TOOLTIP_TITLE     : DEFAULT_DIFFICULTY_TOOLTIP_TITLE }>
                    <span
                ...
                <IconButton onClick={() =>{
                  reset(countDownConstant, PUNCT_DIFFICULTY, language, false);
                }}>
                  <Tooltip
                  title={
                    language === ENGLISH_MODE
                  ...
                  >
                    <span className={getDifficultyButtonClassName(PUNCT_DIFFICULTY)}>
                    {PUNCT_DIFFICULTY}
                  </span>
                  </Tooltip>
                ...
                <IconButton onClick={() => {   reset(countDownConstant, CODE_DIFFICULTY, language, false); }}>
                  <Tooltip title={   language === ENGLISH_MODE     ? CODE_DIFFICULTY_TOOLTIP_TITLE     : CODE_DIFFICULTY_TOOLTIP_TITLE }>
                    <span className={getDifficultyButtonClassName(CODE_DIFFICULTY)}>
                      {CODE_DIFFICULTY}
                    </span>
                  </Tooltip>
                </IconButton>
